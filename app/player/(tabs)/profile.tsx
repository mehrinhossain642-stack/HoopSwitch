...
import { useContentContainerStyle, Screen } from '../../../components/Screen';
...
export default function PlayerProfile() {
  ...
  const contentStyle = useContentContainerStyle({ paddingTop: 20, paddingBottom: 0 });
  ...
  /**
   * Optimistically apply the edit, then PATCH. On failure we revert by refetching,
   * and EditableField shows its rejected state.
   */
    ...
    <Screen edges={[]}>
      <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <ProfileHero
          ...
          action={<SettingsButton href="/player/settings" />}
          stats={[
        ...
        {/* The reel bleeds to the screen edge so the next tile is visibly cut off,
        ...
        <View style={{ ...contentStyle, paddingTop: 24, paddingBottom: 32 }}>
