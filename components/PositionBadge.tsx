 ...
 * repeated token in the app, and the squared-off treatment is what makes them
 * read as roster shorthand rather than generic tags.
 */
export function PositionBadge({
  ...
  return (
    <View
      ...
      <Text className={`font-stat-bold tracking-stat ${LABEL[tone]} ${TEXT[size]}`}>
        {position}
      </Text>
    </View>
  );
