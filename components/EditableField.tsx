...
type EditableFieldProps = {
  ...
  value: string;
  /**
   * Commits an edit. Return false to reject the input — the row reverts to the
   * previous value. Keeps parsing/validation with the owner of the state.
   */
...
/**
 * Labeled row that swaps into an input in place. Rows are 44px tall so the whole
 * row is a comfortable target, and the value carries a visible pencil rather than
 * relying on users guessing that text is tappable.
 */
