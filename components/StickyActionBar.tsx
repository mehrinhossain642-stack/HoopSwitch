 ...
 * scrolling page shouldn't be buried at the end of it, and pinning also keeps
 * the CTA clear of the gesture area on both platforms.
 *
 * Pair with `STICKY_BAR_CLEARANCE` on the scroll content so nothing hides
 * behind it.
 */
export function StickyActionBar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <View
      ...
      <View
        className="w-full self-center flex-row items-center pt-3"
