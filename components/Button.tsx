...
// Fills must come from className, not a style callback — NativeWind drops a
// `backgroundColor` returned from a Pressable style function, which silently
// leaves the button transparent.
 ...
 * spins, `done` becomes a non-interactive confirmation, and `disabled` drops
 * emphasis without hiding the label.
 */
