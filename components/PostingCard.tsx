 ...
 * rail keeps the ranking legible through a fast scroll, and the fit score sits in
 * its own footer band so the number and the action are the last things seen.
 */
