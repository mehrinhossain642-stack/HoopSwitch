...
/**
 * The app's text input. Always carries a visible label — placeholder-only
 * fields lose their meaning the moment someone starts typing — and shows an
 * orange focus ring so the active field is obvious on both platforms.
 */
  ...
  return (
    <View className={`mb-4 ${className}`}>
      ...
      <View
        ...
        // 2px when active reads as a focus ring without shifting the layout,
        // since the border box is the same either way.
        ...
        <TextInput
          ...
          // 48px clears the 44pt touch minimum, and 15px avoids iOS Safari's
