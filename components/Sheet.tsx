 ...
 * lists that don't fit inline open here instead of expanding in place — an inline
 * dropdown shoves the rest of the form down as it opens.
 *
...
export function SheetRow({
  ...
  return (
    <Touchable
      ...
      scaleTo={1}
      dimTo={0.6}
      className={`flex-row items-center px-5 py-3.5 ${last ? '' : 'border-b border-border'} ${
